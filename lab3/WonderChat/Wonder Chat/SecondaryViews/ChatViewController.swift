...
class ChatViewController: JSQMessagesViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, IQAudioRecorderViewControllerDelegate {
    ...
    override func collectionView(_ collectionView: JSQMessagesCollectionView!, attributedTextForCellBottomLabelAt indexPath: IndexPath!) -> NSAttributedString! {
        ...
        case kREAD:
            let statusText = "Read" + " " + readTimeFrom(dateString: message[kREADDATE] as!
                String)
    ...
    override func didPressSend(_ button: UIButton!, withMessageText text: String!, senderId: String!, senderDisplayName: String!, date: Date!) {
        ...
        if text != "" {
            ...
            let audioVC = AudioViewController.init(delegate_: self)
    ...
    override func collectionView(_ collectionView: JSQMessagesCollectionView!, didTapMessageBubbleAt indexPath: IndexPath!) {
        print("tap at message at \(indexPath.row)")
    ...
    func loadMoreMessages(maxNumber: Int, minNumber: Int) {
        ...
        for i in (minMessageNumber ... maxMessageNumber).reversed() {
            ...
            let messageDictionary = loadedMessages[i]
            inserNewMessage(messageDictionary: messageDictionary)
            loadedmessagesCount += 1
        }
        loadOld = true
        self.showLoadEarlierMessagesHeader = (loadedmessagesCount != loadedMessages.count)
    ...
    func inserNewMessage(messageDictionary: NSDictionary) {
